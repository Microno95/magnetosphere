...
def MP_Pressure(Pd):
    return 12.2*(2./Pd)**(1./6)

def MP_Shue1997(th,DP,Bz):
    ''' Shue 1998 Magnetopause model. Returns the MP distance for given 
    theta (r), dynamic pressure (nPa) and Bz (nT).
...
def MP_Lin2010(phi_in,th_in,Pd,Pm,Bz,tilt=0.):
    ...
    and Bz (in nT).
    * phi: Zenith angle from positive x axis (zenith)
    * theta: Azimuth angle from y axis, about x axis
